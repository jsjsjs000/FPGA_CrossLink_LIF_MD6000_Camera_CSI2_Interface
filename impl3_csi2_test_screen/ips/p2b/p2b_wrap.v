...
// Specify the target TX gear: 8/16
 ...
 // Sets the number of incoming pixel per pixel clock
  ...
  input wire [PIX_WIDTH/2-1:0] pix_half_data_i,   // Input pixel data 0
...
// txfr_sig---						
  ...
  input wire [3:0] byte_data_sel_i, // Output byte data select
  output reg [3:0] byte_data_o	    // Output half byte data.
);
...
//if (DATA_WIDTH == 16) begin
  ...
  always @(*) begin
    case (byte_data_sel_i)
      4'b0000 : byte_data_o = p2b_byte_data_w[ 3: 0];	
      4'b0001 : byte_data_o = p2b_byte_data_w[ 7: 4];	
      4'b0010 : byte_data_o = p2b_byte_data_w[11: 8];	
      4'b0011 : byte_data_o = p2b_byte_data_w[15:12];	
      4'b0100 : byte_data_o = p2b_byte_data_w[19:16];	
      4'b0101 : byte_data_o = p2b_byte_data_w[23:20];	
      4'b0110 : byte_data_o = p2b_byte_data_w[27:24];	
      4'b0111 : byte_data_o = p2b_byte_data_w[31:28];	
      4'b1000 : byte_data_o = p2b_byte_data_w[35:32];	
      4'b1001 : byte_data_o = p2b_byte_data_w[39:36];	
      4'b1010 : byte_data_o = p2b_byte_data_w[43:40];	
      4'b1011 : byte_data_o = p2b_byte_data_w[47:44];	
      4'b1100 : byte_data_o = p2b_byte_data_w[51:48];	
      4'b1101 : byte_data_o = p2b_byte_data_w[55:52];	
      4'b1110 : byte_data_o = p2b_byte_data_w[59:56];	
      default : byte_data_o = p2b_byte_data_w[63:60];	
    endcase
  end
...
//      4'b0101 : byte_data_o = p2b_byte_data_w[23:20];	
//      4'b0110 : byte_data_o = p2b_byte_data_w[27:24];	
//      default : byte_data_o = p2b_byte_data_w[31:28];	
//    endcase
//  end
//
//end
...
wire [PIX_WIDTH-1:0] pix_data_i = {pix_half_data_i, pix_half_data_i};
