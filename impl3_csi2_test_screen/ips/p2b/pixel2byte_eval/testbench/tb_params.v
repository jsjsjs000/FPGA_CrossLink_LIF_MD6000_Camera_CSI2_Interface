...
// SIP_PCLK        - Used to set the period of the input pixel clock (in ps) 7500.0
`define SIP_PCLK 12000.0

// SIP_BCLK        - Used to set the period of the input byte clock (in ps) 6667.0
`define SIP_BCLK 7500.0
...
// NUM_BYTES              - Number of bytes sent per line 144
`define NUM_BYTES 60
